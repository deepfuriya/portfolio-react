...
export default function AboutMe(){
    return (
        <div className="text-center my-5">
            ...
            <p className="lead fw-light mb-2">I'm Deep Rajesh Furiya, a passionate software engineer.</p>
            <p className="text-muted mb-3" style={{fontSize: '1.2rem'}}>I am currently pursuing Masters in Computer Science at University of North Carolina at Charlotte.</p>       
            <p className="text-muted mb-3" style={{fontSize: '1.2rem'}}>Proficient in Kotlin, Java, SQL, Python, PHP, Android and Web Development. Experienced as a Research Assistant and Full Stack Web Developer.</p>
